...
/**
 * Servlet implementation class AddDKHDServlet
 */
@WebServlet("/AddDKHDServlet")
public class AddDKHDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddDKHDServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "INSERT INTO HoatDong(TenHD, DiaDiem, DVToChuc, NgayDienRa, DRL, DCTXH, NoiDung, TrangThai) "
					+ "values('" + TenHD + "', '" + DiaDiem +"', '" + DVToChuc +"', '" + NgayDienRa +"', '" + DRL +"', '" + DCTXH +"', '" + NoiDung +"', false)";
