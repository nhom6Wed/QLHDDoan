                ...
                <div class="w3-col m4">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <p class="text-center"><b>QUẢN LÝ HOẠT ĐỘNG</b>
                            </p>
                        </div>
                        	<div class="panel-body">
								<form class="form-horizontal"  action ="AddDKHDServlet" method = "get">
									...
									<div class="form-inline">
										<label><b>Ngày Diễn Ra</b></label>
										<br> 
										<input type="datetime-local" name="NgayDienRa">
									</div>
									<br>
									<div class="form-inline">
                    ...
                    <div class="w3-container">
                        <div id="id01" class="w3-modal" style="z-index:4">
                            <div class="w3-modal-content w3-animate-zoom">
                                ...
                                <form class="form-horizontal" action="AddTNServlet" method="get">
	                                <div class="w3-panel">            
	                                    <label>Người Nhận</label>
	                                    <input class="w3-input w3-border w3-hover-shadow  w3-margin-bottom" type="text" name ="MSSV">
	                                    <label>Tiêu Đề</label>
	                                    <input class="w3-input w3-border w3-hover-shadow  w3-margin-bottom" type="text" name = "TieuDe">
	                                    <label>Nội Dung</label>
	                                    <input class="w3-input w3-border w3-hover-shadow  w3-margin-bottom" style="height:150px" placeholder="What's on your mind?" name = "NoiDung">
	                                    <div class="button-contain" id="btn-click2" onclick="DisableBtn(this.id)">
											<input type="submit" class="btn btn-primary" value="GỮI TIN NHẮN">
										</div>     
	                                </div>
                                 </form>
                            </div>
		        				...
		        				<table id="t01" class="table table-hover">
									<tr>
										...
										<tr>
											...
											<td><a href="DelDKHDServlet?MaHD=${hd.getMaHD()}"><button type="button" class="btn btn-danger">XÓA</button></a></td>
