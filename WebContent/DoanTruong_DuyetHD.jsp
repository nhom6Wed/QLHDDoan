            ...
            <div class="w3-container">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <p class="text-center"><b>DANH SÁCH HOẠT ĐỘNG CHƯA DUYỆT</b>
                        </p>
                    </div>
                        ...
                        <table id="t01" class="table table-hover">
                            ...
                            <c:forEach items="${lstHD }" var="hd">
                                <tr>
                                    ...
                                    <td>
                                        <a href="DuyetHDServlet?MaHD=${hd.getMaHD()} && ">
                                            <button type="button" class="btn btn-primary" id="btn-click" onclick="DisableBtn(this.id)">DUYỆT</button>
                                        </a>
                                    </td>
                                </tr>
                            </c:forEach>
