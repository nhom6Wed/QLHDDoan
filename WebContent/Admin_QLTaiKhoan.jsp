	...
	<div id="content">
		...
		<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">
		    ...
		    <div class="w3-row">
		        ...
		        <!-- Middle Column -->
		        <div class="w3-col m4" >
		        <form method="post" action="Admin_TaoTaiKhoan.jsp">
		        	<div class="w3-container">
		        		<div class="panel panel-primary">
		        			<div class="panel-heading">
			            		<p class="text-center"><b>QUẢN LÝ TÀI KHOẢN</b></p>
			            	</div>
									...
									<div class="form-inline">
								  	...
								  	<div class="form-inline">
							            ...
							            <select>
										  ...
										  <option value="dtruong">ĐOÀN TRƯỜNG</option>
										  <option value="dkhoa">ĐOÀN KHOA</option>
										  <option value="dvien">ĐOÀN VIÊN</option>
										</select>
								  	</div>
								  	<br>
		        ...
		        <div class="w3-col m8" >
		        	<div class="w3-content">
		        		...
		        		<div class="panel panel-primary">
		        			...
		        			<div class="w3-col m7">
		        				<input type="text" name="search" id="searchid" placeholder="Tìm Tài Khoản..">
		        			</div>
		        			<div class="w3-col m5">
		        			<br>
		        			...
		        			<div class="panel-body">
		        				<table id="t01">
									...
									<c:forEach items="${lstM}" var="dv">
								    <tr>
								        <td>${dv.getUsername()}</td>
								        <td>${dv.getPass()}</td>								        
								        <td>${dv.getEmail()}</td>
								        <td>ĐOÀN VIÊN</td>
								        <td><a href=""><button type="button" class="btn btn-danger">XÓA</button></a></td>
